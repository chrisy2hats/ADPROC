...
public class PipeTypeII extends LongPipe {
    ...
    public PipeTypeII(int newLength, int newDiameter, int newNumColour, int newNumOfPipes, boolean newChemicalResist, boolean newInsulation, boolean newReinforcement) {
